...
<%
				if (session.getAttribute("uname") == null) {
					...
					%><form action="U.log.2013/vv" method="POST"  onSubmit='return showLogin()' name="loginform">
					 ...
					 Username : <input type="text" style="height:18px;" name="uname" class="login"/>
					 Password : <input type="password" style="height:18px;" name="pass" class="login"/> 
					 </span>
					 <input type="submit" class="button topbarbutton" name="ulogin" value="User Login" style="width:100px;height:24px;position:relative;top:2px;border:0px" />
					  <input type="submit" class="button topbarbutton" name="clogin" value="College Login" style="width:100px;height:24px;position:relative;top:2px;border:0px" />
					  <input type="button"  class="button topbarbutton" id="but_signup" value="Sign Up" style="width:70px;height:24px;position:relative;top:2px;border:0px" />
					  </form>
...
<button class="button mainmenuitem" id="but_home">Home</button>
<button class="button mainmenuitem" id="but_aboutus">About Us</button>
<button class="button mainmenuitem" id="but_search">Search</button>
<button class="button mainmenuitem" id="but_allcourses">All Courses</button>
<button class="button mainmenuitem" id="but_cr">Recomendator</button>
...
if (session.getAttribute("uname") != null)
{
	...
	out.println("<button class=\"button mainmenuitem\" id=\"but_profile\">My Profile</button>");
}
%>
<button class="button mainmenuitem" id="but_aboutucost">About UCOST</button>
<button class="button mainmenuitem" id="but_aboutgeu">About GEU</button>
<button class="button mainmenuitem" id="but_contactus">Contact Us</button>
</div>

<div id="searchmenuitems" style="display:none">
<center>
<p/>
<button class="button mainmenuitem" id="but_collegesearch">Colleges</button>
<p>
<button class="button mainmenuitem" id="but_schoolsearch">Schools</button>
</p></center>
</div>
...
<center>
<p/>
<button class="button mainmenuitem" id="but_viewprofile">View/Edit Profile</button>
<p/>
<button class="button mainmenuitem" id="but_changepassword">Change Password</button>
<p/>
</center>
...
<div id="maincontent" class="CONTENT" style="border-radius: 20px">
<h2 class="componentheading">
About Vidya Vikas
</h2>
...
<!-- about geu -->
<div id="aboutgeu" class="about CONTENT">
<h2 class="componentheading">
...
<!-- about ucost -->
<div id="aboutucost" class="about CONTENT">
<h2 class="componentheading">
...
<!-- Past Details --><div id="pastdetails" class="about CONTENT">
...
<td>
<input type="text" class="inputfield" name="other_course" placeholder="Specify Course Name" />
</td>
</tr>
...
<td>Interests:</td>
<td >
<input type="text" name="intr" class="inputfield" style="width:200px;float:left;" placeholder="Enter your Interests">
</td>
</tr>
<tr>
<td></td>
<td></td>
<td>
<input type="submit" style="width:200px;height:35px;" id="carrieroptions" name="carrieroptions" class="button" value="Generate Career Options"/>
</td>
</tr>
</tbody>
</table>
...
<!-- contact us -->
<div id="contactus" class="about CONTENT">
<h2 class="componentheading">
Contact Us
</h2>
...
<!-- Registration Form --><div id="register" class="CONTENT">
...
<tbody>
<tr>
<td style="width:50%">Name:</td><td><input type="text" style="float:left;" class="inputfield" name="name" placeholder="User Name"/></td></tr>

<tr>
<td style="width:50%">Email:</td><td><input type="text" style="float:left;" class="inputfield" name="email" placeholder="Enter Email"/></td >
</tr><tr>
<td>Mobile:</td><td><input type="text" name="phn" style="float:left;" class="inputfield" placeholder="Mobile Number"/></td>
</tr>
<tr>
<td>Gender:</td>
...
<tr>
<td>Institute Name:</td><td><input type="text" style="float:left;" class="inputfield" name="inst" placeholder="School/College Name"/></td>
</tr>
<tr>
<td>City:</td><td><input type="text" style="float:left;" class="inputfield" name="city" placeholder="Enter City"/></td>
</tr>
<tr>
<td>State:</td><td><input type="text" style="float:left;" class="inputfield" name="state" placeholder="Enter State"/></td>
</tr>
</select></td></tr><tr>
<td>Qualification:</td>
...
<td>
<input type="text" style="float:left;" class="inputfield" name="branch" placeholder="Specify Course Name" />
</td>
</tr>
...
<div id="changepass" class="CONTENT">
...
<tbody>
<tr>
<td>Old Password:</td><td><input type="password" class="inputfield" name="opass" palceholder="Enter Old Password"/> </td>
</tr>
<tr>
<td>New Password:</td><td><input type="npassword" class="inputfield" name="npass" palceholder="Enter New Password"/> </td>
</tr>
<tr>
<td>Re Enter New Password:</td><td><input type="rnpassword" class="inputfield" name="nopass" palceholder="Re_Enter New Password"/> </td>
</tr>
<tr>
<td><input type="submit" id="eprofile" name="eprofile" class="button" value="Save"></td>
</tr>
...
<!-- school search -->
<div class="searchbar CONTENT" name="searchform_school" id="schoolsearch">
<form  method="POST" onsubmit='return schsubmit(this)'>
<h2 class="componentheading">
&nbsp;&nbsp;School Search
</h2>
...
<tbody>
<tr>
<td style="width:50%">School Name:</td><td><input type="text" name="school_name"  class="inputfield" placeholder="School Name"/></td>
...
<input type="text" name="school_state" id="school_state"  class="inputfield" placeholder="State"/>
...
<td>City:</td><td>
<input type="text" name="school_city"  class="inputfield" id="school_city" placeholder="City"/>
...
<div id="collegesearch" class="searchbar CONTENT" style="display:none;">
...
<tr>
<td>Course:  </td><td> <input type="text" class="inputfield" name="col_course" id="col_course" placeholder="Type Course Here" /> </td>
