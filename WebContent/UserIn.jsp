...
<script language="javascript">
$(document).ready(function(){
    $('#aboutus,#aboutgeu,#aboutucost,#contactus,#allcourses,#schoolsearch,#collegesearch,#pastdetails').hide();
});
</script>
...
/*Effects for search form*/
 ...
 $("#but_collegesearch").click(function() {
  $("#maincontent,#aboutus,#aboutgeu,#aboutucost,#contactus,#pastdetails,#schoolsearch,#allcourses").slideUp("slow",function() {
   $("#collegesearch").slideDown("slow");
 });
});

 $("#but_cr").click(function() {
	  $("#maincontent,#aboutus,#aboutgeu,#aboutucost,#contactus,#schoolsearch,#collegesearch,#allcourses").slideUp("slow",function() {
	   $("#pastdetails").slideDown("slow");
	 });
	});

 $("#but_schoolsearch").click(function() {
	  $("#maincontent,#aboutus,#aboutgeu,#aboutucost,#contactus,#collegesearch,#pastdetails,#allcourses").slideUp("slow",function() {
	   $("#schoolsearch").slideDown("slow");
	 });
	});

 $("#but_aboutus").click(function() {
	  $("#maincontent,#schoolsearch,#collegesearch,#aboutgeu,#aboutucost,#contactus,#pastdetails,#allcourses").slideUp("slow",function() {
	   $("#aboutus").slideDown("slow");
	 });
	});
 
 $("#but_contactus").click(function() {
	  $("#maincontent,#schoolsearch,#collegesearch,#aboutgeu,#aboutucost,#aboutus,#pastdetails,#allcourses").slideUp("slow",function() {
	   $("#contactus").slideDown("slow");
	 });
	});
 $("#but_aboutgeu").click(function() {
	  $("#maincontent,#schoolsearch,#collegesearch,#contactus,#aboutucost,#aboutus,#pastdetails,#allcourses").slideUp("slow",function() {
	   $("#aboutgeu").slideDown("slow");
	 });
	});

$("#but_home").click(function() {
  $("#schoolsearch,#collegesearch,#aboutgeu,#aboutucost,#aboutus,#contactus,#pastdetails,#allcourses").slideUp("slow",function() {
   $("#maincontent").slideDown("slow");
 });
});

$("#but_aboutucost").click(function() {
	  $("#maincontent,#searchbar,#aboutgeu,#aboutus,#contactus,#schoolsearch,#collegesearch,#pastdetails,#allcourses").slideUp("slow",function() {
	   $("#aboutucost").slideDown("slow");
	 });
	});
	
$("#but_allcourses").click(function() {
	  $("#maincontent,#searchbar,#aboutgeu,#aboutus,#contactus,#schoolsearch,#collegesearch,#pastdetails,#abutucost").slideUp("slow",function() {
...
if (session.getAttribute("username") == null)
{
	...
	out.println("<form action=\"UserLogin.jsp\" method=\"POST\" name=\"loginform\">Username : <input type=\"text\" name=\"name\" class=\"login\"/>   Password : <input type=\"password\" name=\"pass\" class=\"login\"/> <input type=\"submit\" name=\"login\" value=\"Login\"/></form>");
...
<button class="button" id="but_profile">My Prrofile</button>
