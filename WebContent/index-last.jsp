...
<%
				if (session.getAttribute("uname") == null) {
					...
					%><form action="U.log.2013/vv" method="POST"  onSubmit='return showLogin()' name="loginform">
					 ...
					 <input type="submit" class="lbutton" name="ulogin" value="Login" style="width:50px;height:24px;position:relative;top:2px;border:0px" />
					  <input type="submit" class="lbutton" name="clogin" value="College Login" style="width:100px;height:24px;position:relative;top:2px;border:0px" />
					  <input type="button"  class="lbutton" id="but_register" value="Sign Up" style="width:70px;height:24px;position:relative;top:2px;border:0px" />
					  </form>
...
<button class="button buttons" id="but_home">Home</button>
<button class="button buttons" id="but_aboutus">About Us</button>
<button class="sbutton" id="but_search">Search</button>
<button class="button buttons" id="but_allcourses">All Courses</button>
<button class="button buttons" id="but_pastdetails">Recomendator</button>
...
%>
<button class="button buttons" id="but_aboutucost">About UCOST</button>
<button class="button buttons" id="but_aboutgeu">About GEU</button>
<button class="button buttons" id="but_contactus">Contact Us</button>
</div>
...
<center>
<p/>
<button class="button buttons" id="but_profile">View/Edit Profile</button>
<p/>
<button class="button buttons" id="but_changepass">Change Password</button>
<p/>
</center>
...
<!-- about ucost -->
<div id="aboutucost" class="pagecontent about">
<h2 class="componentheading">
...
<!-- Past Details -->
<div id="pastdetails" class="searchbar pagecontent">
...
<!-- contact us -->
<div id="contactus" class="pagecontent about" >
<h2 class="componentheading">
Contact Us
</h2>
...
<!-- about us -->
<div id="aboutus" class="pagecontent about">
<h2 class="componentheading">
Our Team
</h2>
<h2 class="ctheading">
...
<!-- All Courses -->
<div id="allcourses" class="pagecontent about">
<h2 class="componentheading">
All Courses
</h2>
<table border="3">
...
<!-- Registeration Form -->
<div id="register" class="pagecontent searchbar">
...
<div id="profile" class="pagecontent searchbar">
...
<div id="changepass" class="pagecontent searchbar">
...
<p>&nbsp;</p>
</div><!-- schoole search --><div id="schoolsearch" class="pagecontent searchbar">
...
<p>&nbsp;</p>
	...
	<div id="collegesearch" class="pagecontent searchbar" style="display:none;">
