...
$("#but_search").mouseover(function() {
	var left=$("#but_search").css("left");
	$("#searchmenuitems").css("left",left);
...
<%
				if (session.getAttribute("username") == null) {
					...
					%><form action="UserLogin.jsp" method="POST" name="loginform">Username :
					 <input type="text" name="uname" class="login"/>   Password : <input type="password" name="pass" class="login"/> 
					 <input type="submit" class="lbutton" name="login" value="Login"/></form><button position="float:left" class="lbutton" id="but_register">Sign Up</button>
...
<!-- Past Details -->
<div id="pastdetails" class="serachbar">
...
<div id="schoolsearch" class="searchbar">
	<form name="searchform_school" id="searchform_school" method="POST"
					onsubmit='return schsubmit(this)'>
<h2 class="componentheading">
&nbsp;&nbsp;School Search
</h2>
...
<td><input type="submit" id="college_search" name="college_search" class="button" value="Search"/></td>
		...
		<div id="searchresults" class="searchbar">
	...
	<footer>
		<div id="footer">Copyright Protected © 2012 Vidya Vikas | All
			Rights Reserved</div>
	</footer>
	</div>
	</div>
