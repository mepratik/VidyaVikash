...
<%
				if (session.getAttribute("uname") == null) {
					...
					%><form action="U.log.2013/vv" method="POST"  onSubmit='return showLogin()' name="loginform"><span class="loginblock">Username :
					 <input type="text" name="uname" class="login"/>   Password : <input type="password" name="pass" class="login"/> </span>
					 <input type="submit" class="button" name="login" value="Login" style="width:50px;height:24px;position:relative;top:2px;border:0px" /></form>
					 <button  class="button" id="but_signup" style="width:70px;height:24px;position:relative;top:2px;border:0px" />Sign Up</button>
...
<!-- Past Details --><div id="pastdetails" class="about">
<form name="past_details" id="past_details" method="POST">
<h2 class="componentheading">
&nbsp;&nbsp;Past Details
</h2>
...
<p>&nbsp;</p>
</div><!-- schoole search --><div id="schoolsearch" class="searchbar">
